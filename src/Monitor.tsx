      ...
      <group rotation={[-Math.PI / 2, 0, 0]} scale={0.026}>
        <group rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
          ...
          >
            ...
            <Html
              className={`w-[490px] h-[335px] rounded-[45px] overflow-y-auto p-0 ${props.isMonitorOn ? "bg-white" : "hidden"}`}
              rotation-x={1.25}
              position={[0, -4.33, 4.62]}
              transform
              occlude="raycast" // FIX THE FUCKING BLENDIIIIIIIIIIIIIIIIIIIIIIIIING
              // receiveShadow
              // distanceFactor={1}
              // zIndexRange={[1, 0]}
              occlusionTest
            ...
            >
              ...
              <section className={`w-full h-full overflow-y-auto ${props.isMonitorOn ? "" : "hidden"}`}>
